...
const Wildomar = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Wildomar - Ivan Fountain Service </title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Wildomar, CA area."
        />
        <meta
          name="keywords"
          content="Fountain Contractor Wildomar, Fountain Contractor Wildomar CA, Fountain Contractors Wildomar, Fountain Contractors Wildomar CA, Fountain Delivery Wildomar, Fountain Delivery Wildomar CA, Fountain Install Wildomar, Fountain Install Wildomar CA, Fountain Installation Wildomar, Fountain Installation Wildomar CA, Fountain Maintenance Wildomar, Fountain Maintenance Wildomar CA, Fountain Service Wildomar, Fountain Service Wildomar CA, Fountain Services Wildomar, Fountain Services Wildomar CA, Home and Garden Maintenance Wildomar, Home and Garden Maintenance Wildomar CA, Waterfalls Wildomar, Waterfalls Wildomar CA"
        />
        <link rel="canonical" href="/fountain-service-Wildomar" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Wildomar, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Wildomar Fountain Service"
                title="Wildomar Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Wildomar Fountain Maintenance"
                title="Wildomar Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Wildomar Fountain Installation"
                title="Wildomar Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Wildomar Fountain Repair"
                title="Wildomar Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Wildomar Fountain Restoration"
                title="Wildomar Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Wildomar Fountain Delivary"
                title="Wildomar Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Wildomar Fountain Replacement"
                title="Wildomar Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Wildomar Fountain Contractor"
                title="Wildomar Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Wildomar CA Fountain Maintenance"
                title="Wildomar CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Wildomar CA Fountain Installation"
                title="Wildomar CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Wildomar"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Wildomar, CA."
        image1={delivary}
        image2={Installation}
        alt1="Wildomar Fountain Delivery"
        alt2="Wildomar Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Wildomar Fountain Installation"
        Title2="Wildomar CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Wildomar"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Wildomar Fountain Repair"
        alt2="Wildomar Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Wildomar Fountain Repair"
        Title2="Wildomar CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Wildomar"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Wildomar Fountain Maintenance"
        alt2="Wildomar CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Wildomar Fountain Maintenance"
        Title2="Wildomar CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Wildomar"
        ...
        image1={emergency}
        image2={business}
        alt1="Wildomar Fountain Restoration"
        alt2="Wildomar Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Wildomar Fountain Restoration"
        Title2="Wildomar CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
