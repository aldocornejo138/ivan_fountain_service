...
const sliderImages = [
  {
    ...
    width: 624,
    height: 831,
    alt: "FallBrook Fountain Service",
  },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
    alt: "FallBrook Fountain Maintenance",
  },
  {
    src: sliderImg3,
    width: 594,
    height: 787,
    alt: "FallBrook Fountain Installation",
  },
  {
    src: sliderImg4,
    width: 786,
    height: 987,
    alt: "FallBrook Fountain Repair",
  },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
    alt: "FallBrook Fountain Restoration",
  },
  {
    src: sliderImg6,
    width: 781,
    height: 1033,
    alt: "FallBrook Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
    height: 1764,
    alt: "FallBrook Fountain Replacement",
  },
  {
    src: sliderImg8,
    width: 757,
    height: 995,
    alt: "FallBrook Fountain Contractor",
  },
  {
    src: sliderImg9,
    width: 600,
    height: 775,
    alt: "FallBrook CA Fountain Maintenance",
  },
  {
    src: sliderImg10,
    width: 755,
    height: 995,
    alt: "FallBrook CA Fountain Installation",
  },
];
...
const FallBrook = () => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service FallBrook - Ivan Fountain Service</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Fountain Contractor FallBrook, Fountain Contractor FallBrook CA, Fountain Contractors FallBrook, Fountain Contractors FallBrook CA, Fountain Delivery FallBrook, Fountain Delivery FallBrook CA, Fountain Install FallBrook, Fountain Install FallBrook CA, Fountain Installation FallBrook, Fountain Installation FallBrook CA, Fountain Maintenance FallBrook, Fountain Maintenance FallBrook CA, Fountain Service FallBrook, Fountain Service FallBrook CA, Fountain Services FallBrook, Fountain Services FallBrook CA, Home and Garden Maintenance FallBrook, Home and Garden Maintenance FallBrook CA, Waterfalls FallBrook, Waterfalls FallBrook CA"
        />
        <link rel="canonical" href="/fountain-service-FallBrook" />
      </Helmet>
      <div className="head">
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in FallBrook</h1>
      ...
      >
        <p>
          ...
          proudly serves FallBrook, CA area. We offer many services beyond
      ...
      <ServiceSection
        title="Fountain Installation FallBrook"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in FallBrook, CA."
        image1={serviceImages.delivary.src}
        image2={serviceImages.installation.src}
        alt1="FallBrook Fountain Delivery"
        alt2="FallBrook Fountain Installation"
      ...
      />
      <ServiceSection
        title="Fountain Repair FallBrook"
        ...
        alt1="FallBrook Fountain Repair"
        alt2="FallBrook CA Fountain Repair"
      ...
      />
      <ServiceSection
        title="Fountain Maintenance FallBrook"
        ...
        alt1="FallBrook Fountain Maintenance"
        alt2="FallBrook CA Fountain Maintenance"
      ...
      />
      <ServiceSection
        title="Fountain Restoration FallBrook"
        ...
        alt1="FallBrook Fountain Restoration"
        alt2="FallBrook Fountain Restoration"
