...
const RanchoSantaFe = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Rancho Santa Fe - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Rancho Santa Fe, CA area."
        />
      ...
      >
        ...
        <p>
          ...
          proudly serves Rancho Santa Fe, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Rancho Santa Fe Fountain Service"
                title="Rancho Santa Fe Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Rancho Santa Fe Fountain Maintenance"
                title="Rancho Santa Fe Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Rancho Santa Fe Fountain Installation"
                title="Rancho Santa Fe Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Rancho Santa Fe Fountain Repair"
                title="Rancho Santa Fe Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Rancho Santa Fe Fountain Restoration"
                title="Rancho Santa Fe Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Rancho Santa Fe Fountain Delivary"
                title="Rancho Santa Fe Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Rancho Santa Fe Fountain Replacement"
                title="Rancho Santa Fe Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Rancho Santa Fe Fountain Contractor"
                title="Rancho Santa Fe Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Rancho Santa Fe CA Fountain Maintenance"
                title="Rancho Santa Fe CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Rancho Santa Fe CA Fountain Installation"
                title="Rancho Santa Fe CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        ...
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Rancho Santa Fe, CA."
        image1={delivary}
        image2={Installation}
        alt1="Rancho Santa Fe Fountain Delivery"
        alt2="Rancho Santa Fe Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Rancho Santa Fe Fountain Installation"
        Title2="Rancho Santa Fe CA Fountain Delivery"
      />
      ...
      <ServiceSection2
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Rancho Santa Fe Fountain Repair"
        alt2="Rancho Santa Fe Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Rancho Santa Fe Fountain Repair"
        Title2="Rancho Santa Fe CA Fountain Repair"
      />
      ...
      <ServiceSection
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Rancho Santa Fe Fountain Maintenance"
        alt2="Rancho Santa Fe CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Rancho Santa Fe Fountain Maintenance"
        Title2="Rancho Santa Fe CA Fountain Maintenance"
      />
      ...
      <ServiceSection2
        ...
        image1={emergency}
        image2={business}
        alt1="Rancho Santa Fe Fountain Restoration"
        alt2="Rancho Santa Fe Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Rancho Santa Fe Fountain Restoration"
        Title2="Rancho Santa Fe CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
