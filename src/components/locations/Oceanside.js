...
const Oceanside = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Oceanside - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Oceanside, CA area."
        />
      ...
      >
        ...
        <p>
          ...
          proudly serves Oceanside, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Oceanside Fountain Service"
                title="Oceanside Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Oceanside Fountain Maintenance"
                title="Oceanside Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Oceanside Fountain Installation"
                title="Oceanside Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Oceanside Fountain Repair"
                title="Oceanside Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Oceanside Fountain Restoration"
                title="Oceanside Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Oceanside Fountain Delivary"
                title="Oceanside Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Oceanside Fountain Replacement"
                title="Oceanside Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Oceanside Fountain Contractor"
                title="Oceanside Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Oceanside CA Fountain Maintenance"
                title="Oceanside CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Oceanside CA Fountain Installation"
                title="Oceanside CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        ...
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Oceanside, CA."
        image1={delivary}
        image2={Installation}
        alt1="Oceanside Fountain Delivery"
        alt2="Oceanside Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Oceanside Fountain Installation"
        Title2="Oceanside CA Fountain Delivery"
      />
      ...
      <ServiceSection2
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Oceanside Fountain Repair"
        alt2="Oceanside Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Oceanside Fountain Repair"
        Title2="Oceanside CA Fountain Repair"
      />
      ...
      <ServiceSection
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Oceanside Fountain Maintenance"
        alt2="Oceanside CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Oceanside Fountain Maintenance"
        Title2="Oceanside CA Fountain Maintenance"
      />
      ...
      <ServiceSection2
        ...
        image1={emergency}
        image2={business}
        alt1="Oceanside Fountain Restoration"
        alt2="Oceanside Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Oceanside Fountain Restoration"
        Title2="Oceanside CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
