...
const SanMarcos = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service San Marcos - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves San Marcos, CA area."
        />
        <link rel="canonical" href="/fountain-service-San Marcos" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves San Marcos, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="San Marcos Fountain Service"
                title="San Marcos Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="San Marcos Fountain Maintenance"
                title="San Marcos Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="San Marcos Fountain Installation"
                title="San Marcos Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="San Marcos Fountain Repair"
                title="San Marcos Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="San Marcos Fountain Restoration"
                title="San Marcos Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="San Marcos Fountain Delivary"
                title="San Marcos Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="San Marcos Fountain Replacement"
                title="San Marcos Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="San Marcos Fountain Contractor"
                title="San Marcos Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="San Marcos CA Fountain Maintenance"
                title="San Marcos CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="San Marcos CA Fountain Installation"
                title="San Marcos CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation San Marcos"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in San Marcos, CA."
        image1={delivary}
        image2={Installation}
        alt1="San Marcos Fountain Delivery"
        alt2="San Marcos Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="San Marcos Fountain Installation"
        Title2="San Marcos CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair San Marcos"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="San Marcos Fountain Repair"
        alt2="San Marcos Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="San Marcos Fountain Repair"
        Title2="San Marcos CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance San Marcos"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="San Marcos Fountain Maintenance"
        alt2="San Marcos CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="San Marcos Fountain Maintenance"
        Title2="San Marcos CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration San Marcos"
        ...
        image1={emergency}
        image2={business}
        alt1="San Marcos Fountain Restoration"
        alt2="San Marcos Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="San Marcos Fountain Restoration"
        Title2="San Marcos CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
