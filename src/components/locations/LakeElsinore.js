  ...
  return (
    <section className="app">
      <Helmet>
        ...
        />
        <link rel="canonical" href="/fountain-service-Lake Elsinore" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Lake Elsinore, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Lake Elsinore Fountain Service"
                title="Lake Elsinore Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Lake Elsinore Fountain Maintenance"
                title="Lake Elsinore Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Lake Elsinore Fountain Installation"
                title="Lake Elsinore Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Lake Elsinore Fountain Repair"
                title="Lake Elsinore Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Lake Elsinore Fountain Restoration"
                title="Lake Elsinore Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Lake Elsinore Fountain Delivary"
                title="Lake Elsinore Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Lake Elsinore Fountain Replacement"
                title="Lake Elsinore Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Lake Elsinore Fountain Contractor"
                title="Lake Elsinore Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Lake Elsinore CA Fountain Maintenance"
                title="Lake Elsinore CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Lake Elsinore CA Fountain Installation"
                title="Lake Elsinore CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Lake Elsinore"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Lake Elsinore, CA."
        image1={delivary}
        image2={Installation}
        alt1="Lake Elsinore Fountain Delivery"
        alt2="Lake Elsinore Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Lake Elsinore Fountain Installation"
        Title2="Lake Elsinore CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Lake Elsinore"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Lake Elsinore Fountain Repair"
        alt2="Lake Elsinore Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Lake Elsinore Fountain Repair"
        Title2="Lake Elsinore CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Lake Elsinore"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Lake Elsinore Fountain Maintenance"
        alt2="Lake Elsinore CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Lake Elsinore Fountain Maintenance"
        Title2="Lake Elsinore CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Lake Elsinore"
        ...
        image1={emergency}
        image2={business}
        alt1="Lake Elsinore Fountain Restoration"
        alt2="Lake Elsinore Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Lake Elsinore Fountain Restoration"
        Title2="Lake Elsinore CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
