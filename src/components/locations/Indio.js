...
const sliderImages = [
  { src: sliderImg1, width: 624, height: 831, alt: "Indio Fountain Service" },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
    alt: "Indio Fountain Maintenance",
  },
  {
    src: sliderImg3,
    width: 594,
    height: 787,
    alt: "Indio Fountain Installation",
  },
  { src: sliderImg4, width: 786, height: 987, alt: "Indio Fountain Repair" },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
    alt: "Indio Fountain Restoration",
  },
  {
    src: sliderImg6,
    width: 781,
    height: 1033,
    alt: "Indio Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
    height: 1764,
    alt: "Indio Fountain Replacement",
  },
  {
    src: sliderImg8,
    width: 757,
    height: 995,
    alt: "Indio Fountain Contractor",
  },
  {
    src: sliderImg9,
    width: 600,
    height: 775,
    alt: "Indio CA Fountain Maintenance",
  },
  {
    src: sliderImg10,
    width: 755,
    height: 995,
    alt: "Indio CA Fountain Installation",
  },
];
  ...
  return (
    <section className="app">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Fountain Contractor Indio, Fountain Contractor Indio CA, Fountain Contractors Indio, Fountain Contractors Indio CA, Fountain Delivery Indio, Fountain Delivery Indio CA, Fountain Install Indio, Fountain Install Indio CA, Fountain Installation Indio, Fountain Installation Indio CA, Fountain Maintenance Indio, Fountain Maintenance Indio CA, Fountain Service Indio, Fountain Service Indio CA, Fountain Services Indio, Fountain Services Indio CA, Home and Garden Maintenance Indio, Home and Garden Maintenance Indio CA, Waterfalls Indio, Waterfalls Indio CA"
        />
        <link rel="canonical" href="/fountain-service-Indio" />
      </Helmet>
      <div className="head">
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Indio</h1>
      ...
      >
        <p>
          ...
          proudly serves Indio, CA area. We offer many services beyond fountain
      ...
      <ServiceSection
        title="Fountain Installation Indio"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Indio, CA."
        image1={serviceImages.delivary.src}
        image2={serviceImages.installation.src}
        alt1="Indio Fountain Delivery"
        alt2="Indio Fountain Installation"
      ...
      <ServiceSection
        ...
        alt1="Indio Fountain Repair"
        alt2="Indio CA Fountain Repair"
      ...
      />
      <ServiceSection
        title="Fountain Maintenance Indio"
        ...
        alt1="Indio Fountain Maintenance"
        alt2="Indio CA Fountain Maintenance"
      ...
      />
      <ServiceSection
        title="Fountain Restoration Indio"
        ...
        alt1="Indio Fountain Restoration"
        alt2="Indio Fountain Restoration"
