...
const sliderImages = [
  { src: sliderImg1, width: 624, height: 831, alt: "Hemet Fountain Service" },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
    alt: "Hemet Fountain Maintenance",
  },
  {
    src: sliderImg3,
    width: 594,
    height: 787,
    alt: "Hemet Fountain Installation",
  },
  { src: sliderImg4, width: 786, height: 987, alt: "Hemet Fountain Repair" },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
    alt: "Hemet Fountain Restoration",
  },
  {
    src: sliderImg6,
    width: 781,
    height: 1033,
    alt: "Hemet Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
    height: 1764,
    alt: "Hemet Fountain Replacement",
  },
  {
    src: sliderImg8,
    width: 757,
    height: 995,
    alt: "Hemet Fountain Contractor",
  },
  {
    src: sliderImg9,
    width: 600,
    height: 775,
    alt: "Hemet CA Fountain Maintenance",
  },
  {
    src: sliderImg10,
    width: 755,
    height: 995,
    alt: "Hemet CA Fountain Installation",
  },
];
  ...
  return (
    <section className="app">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Fountain Contractor Hemet, Fountain Contractor Hemet CA, Fountain Contractors Hemet, Fountain Contractors Hemet CA, Fountain Delivery Hemet, Fountain Delivery Hemet CA, Fountain Install Hemet, Fountain Install Hemet CA, Fountain Installation Hemet, Fountain Installation Hemet CA, Fountain Maintenance Hemet, Fountain Maintenance Hemet CA, Fountain Service Hemet, Fountain Service Hemet CA, Fountain Services Hemet, Fountain Services Hemet CA, Home and Garden Maintenance Hemet, Home and Garden Maintenance Hemet CA, Waterfalls Hemet, Waterfalls Hemet CA"
        />
        <link rel="canonical" href="/fountain-service-Hemet" />
      </Helmet>
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Hemet</h1>
      ...
      >
        <p>
          ...
          proudly serves Hemet, CA area. We offer many services beyond fountain
      ...
      <ServiceSection
        title="Fountain Installation Hemet"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Hemet, CA."
        image1={serviceImages.delivary.src}
        image2={serviceImages.installation.src}
        alt1="Hemet Fountain Delivery"
        alt2="Hemet Fountain Installation"
      ...
      <ServiceSection
        ...
        alt1="Hemet Fountain Repair"
        alt2="Hemet CA Fountain Repair"
      ...
      <ServiceSection
        title="Fountain Maintenance Hemet"
        ...
        alt1="Hemet Fountain Maintenance"
        alt2="Hemet CA Fountain Maintenance"
      ...
      <ServiceSection
        title="Fountain Restoration Hemet"
        ...
        alt1="Hemet Fountain Restoration"
        alt2="Hemet Fountain Restoration"
