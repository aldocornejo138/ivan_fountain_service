...
const Menifee = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Menifee - Ivan Fountain Service </title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Menifee, CA area."
        />
        <meta
          name="keywords"
          content="Fountain Contractor Menifee, Fountain Contractor Menifee CA, Fountain Contractors Menifee, Fountain Contractors Menifee CA, Fountain Delivery Menifee, Fountain Delivery Menifee CA, Fountain Install Menifee, Fountain Install Menifee CA, Fountain Installation Menifee, Fountain Installation Menifee CA, Fountain Maintenance Menifee, Fountain Maintenance Menifee CA, Fountain Service Menifee, Fountain Service Menifee CA, Fountain Services Menifee, Fountain Services Menifee CA, Home and Garden Maintenance Menifee, Home and Garden Maintenance Menifee CA, Waterfalls Menifee, Waterfalls Menifee CA"
        />
        <link rel="canonical" href="/fountain-service-Menifee" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Menifee, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Menifee Fountain Service"
                title="Menifee Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Menifee Fountain Maintenance"
                title="Menifee Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Menifee Fountain Installation"
                title="Menifee Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Menifee Fountain Repair"
                title="Menifee Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Menifee Fountain Restoration"
                title="Menifee Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Menifee Fountain Delivary"
                title="Menifee Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Menifee Fountain Replacement"
                title="Menifee Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Menifee Fountain Contractor"
                title="Menifee Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Menifee CA Fountain Maintenance"
                title="Menifee CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Menifee CA Fountain Installation"
                title="Menifee CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Menifee"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Menifee, CA."
        image1={delivary}
        image2={Installation}
        alt1="Menifee Fountain Delivery"
        alt2="Menifee Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Menifee Fountain Installation"
        Title2="Menifee CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Menifee"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Menifee Fountain Repair"
        alt2="Menifee Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Menifee Fountain Repair"
        Title2="Menifee CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Menifee"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Menifee Fountain Maintenance"
        alt2="Menifee CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Menifee Fountain Maintenance"
        Title2="Menifee CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Menifee"
        ...
        image1={emergency}
        image2={business}
        alt1="Menifee Fountain Restoration"
        alt2="Menifee Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Menifee Fountain Restoration"
        Title2="Menifee CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
