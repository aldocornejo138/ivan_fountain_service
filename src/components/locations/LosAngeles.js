...
const sliderImages = [
  {
    ...
    width: 624,
    height: 831,
    alt: "Los Angeles Fountain Service",
  },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
    alt: "Los Angeles Fountain Maintenance",
  },
  {
    src: sliderImg3,
    width: 594,
    height: 787,
    alt: "Los Angeles Fountain Installation",
  },
  {
    src: sliderImg4,
    width: 786,
    height: 987,
    alt: "Los Angeles Fountain Repair",
  },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
    alt: "Los Angeles Fountain Restoration",
  },
  {
    src: sliderImg6,
    width: 781,
    height: 1033,
    alt: "Los Angeles Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
    height: 1764,
    alt: "Los Angeles Fountain Replacement",
  },
  {
    src: sliderImg8,
    width: 757,
    height: 995,
    alt: "Los Angeles Fountain Contractor",
  },
  {
    src: sliderImg9,
    width: 600,
    height: 775,
    alt: "Los Angeles CA Fountain Maintenance",
  },
  {
    src: sliderImg10,
    width: 755,
    height: 995,
    alt: "Los Angeles CA Fountain Installation",
  },
];
...
const LosAngeles = () => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Los Angeles - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Los Angeles, CA area."
        />
        <meta
          name="keywords"
          content="Fountain Contractor Los Angeles, Fountain Contractor Los Angeles CA, Fountain Contractors Los Angeles, Fountain Contractors Los Angeles CA, Fountain Delivery Los Angeles, Fountain Delivery Los Angeles CA, Fountain Install Los Angeles, Fountain Install Los Angeles CA, Fountain Installation Los Angeles, Fountain Installation Los Angeles CA, Fountain Maintenance Los Angeles, Fountain Maintenance Los Angeles CA, Fountain Service Los Angeles, Fountain Service Los Angeles CA, Fountain Services Los Angeles, Fountain Services Los Angeles CA, Home and Garden Maintenance Los Angeles, Home and Garden Maintenance Los Angeles CA, Waterfalls Los Angeles, Waterfalls Los Angeles CA"
        />
        <link rel="canonical" href="/fountain-service-Los Angeles" />
      </Helmet>
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Los Angeles</h1>
      ...
      >
        <p>
          ...
          proudly serves Los Angeles, CA area. We offer many services beyond
      ...
      <ServiceSection
        title="Fountain Installation Los Angeles"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Los Angeles, CA."
        image1={serviceImages.delivary.src}
        image2={serviceImages.installation.src}
        alt1="Los Angeles Fountain Delivery"
        alt2="Los Angeles Fountain Installation"
      ...
      <ServiceSection
        title="Fountain Repair Los Angeles"
        ...
        alt1="Los Angeles Fountain Repair"
        alt2="Los Angeles CA Fountain Repair"
      ...
      <ServiceSection
        title="Fountain Maintenance Los Angeles"
        ...
        alt1="Los Angeles Fountain Maintenance"
        alt2="Los Angeles CA Fountain Maintenance"
      ...
      <ServiceSection
        title="Fountain Restoration Los Angeles"
        ...
        alt1="Los Angeles Fountain Restoration"
        alt2="Los Angeles Fountain Restoration"
