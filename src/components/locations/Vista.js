  ...
  return (
    <section className="app">
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Vista Fountain Service"
                title="Vista Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Vista Fountain Repair"
                title="Vista Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Vista Fountain Delivary"
                title="Vista Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                ...
                title="Vista CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        ...
        width2="1500"
        height2="2000"
        Title1="Vista Fountain Installation"
        Title2="Vista CA Fountain Delivery"
      />
      ...
      <ServiceSection2
        ...
        width2="2048"
        height2="2506"
        Title1="Vista Fountain Repair"
        Title2="Vista CA Fountain Repair"
      />
      ...
      <ServiceSection
        ...
        width2="1500"
        height2="2000"
        Title1="Vista Fountain Maintenance"
        Title2="Vista CA Fountain Maintenance"
      />
      ...
      <ServiceSection2
        ...
        width2="1474"
        height2="2394"
        Title1="Vista Fountain Restoration"
        Title2="Vista CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
