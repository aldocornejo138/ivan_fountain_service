...
const sliderImages = [
  ...
  },
  {
    ...
    width: 781,
    height: 1033,
    alt: "Chula Vista Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
  ...
  return (
    <section className="app">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Fountain Contractor Chula Vista, Fountain Contractor Chula Vista CA, Fountain Contractors Chula Vista, Fountain Contractors Chula Vista CA, Fountain Delivery Chula Vista, Fountain Delivery Chula Vista CA, Fountain Install Chula Vista, Fountain Install Chula Vista CA, Fountain Installation Chula Vista, Fountain Installation Chula Vista CA, Fountain Maintenance Chula Vista, Fountain Maintenance Chula Vista CA, Fountain Service Chula Vista, Fountain Service Chula Vista CA, Fountain Services Chula Vista, Fountain Services Chula Vista CA, Home and Garden Maintenance Chula Vista, Home and Garden Maintenance Chula Vista CA, Waterfalls Chula Vista, Waterfalls Chula Vista CA"
        />
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Chula Vista</h1>
