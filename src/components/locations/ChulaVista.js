  ...
  return (
    <section className="app">
      <Helmet>
        ...
        />
        <link rel="canonical" href="/fountain-service-Chula Vista" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Chula Vista, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Chula Vista Fountain Service"
                title="Chula Vista Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Chula Vista Fountain Maintenance"
                title="Chula Vista Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Chula Vista Fountain Installation"
                title="Chula Vista Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Chula Vista Fountain Repair"
                title="Chula Vista Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Chula Vista Fountain Restoration"
                title="Chula Vista Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Chula Vista Fountain Delivary"
                title="Chula Vista Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Chula Vista Fountain Replacement"
                title="Chula Vista Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Chula Vista Fountain Contractor"
                title="Chula Vista Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Chula Vista CA Fountain Maintenance"
                title="Chula Vista CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Chula Vista CA Fountain Installation"
                title="Chula Vista CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Chula Vista"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Chula Vista, CA."
        image1={delivary}
        image2={Installation}
        alt1="Chula Vista Fountain Delivery"
        alt2="Chula Vista Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Chula Vista Fountain Installation"
        Title2="Chula Vista CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Chula Vista"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Chula Vista Fountain Repair"
        alt2="Chula Vista Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Chula Vista Fountain Repair"
        Title2="Chula Vista CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Chula Vista"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Chula Vista Fountain Maintenance"
        alt2="Chula Vista CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Chula Vista Fountain Maintenance"
        Title2="Chula Vista CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Chula Vista"
        ...
        image1={emergency}
        image2={business}
        alt1="Chula Vista Fountain Restoration"
        alt2="Chula Vista Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Chula Vista Fountain Restoration"
        Title2="Chula Vista CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
