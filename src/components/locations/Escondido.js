...
const Escondido = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Escondido - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Escondido, CA area."
        />
        <link rel="canonical" href="/fountain-service-Escondido" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Escondido, CA area. We offer many services beyond
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Escondido Fountain Service"
                title="Escondido Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Escondido Fountain Maintenance"
                title="Escondido Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Escondido Fountain Installation"
                title="Escondido Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Escondido Fountain Repair"
                title="Escondido Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Escondido Fountain Restoration"
                title="Escondido Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Escondido Fountain Delivary"
                title="Escondido Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Escondido Fountain Replacement"
                title="Escondido Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Escondido Fountain Contractor"
                title="Escondido Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Escondido CA Fountain Maintenance"
                title="Escondido CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Escondido CA Fountain Installation"
                title="Escondido CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Escondido"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Escondido, CA."
        image1={delivary}
        image2={Installation}
        alt1="Escondido Fountain Delivery"
        alt2="Escondido Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Escondido Fountain Installation"
        Title2="Escondido CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Escondido"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Escondido Fountain Repair"
        alt2="Escondido Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Escondido Fountain Repair"
        Title2="Escondido CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Escondido"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Escondido Fountain Maintenance"
        alt2="Escondido CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Escondido Fountain Maintenance"
        Title2="Escondido CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Escondido"
        ...
        image1={emergency}
        image2={business}
        alt1="Escondido Fountain Restoration"
        alt2="Escondido Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Escondido Fountain Restoration"
        Title2="Escondido CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
