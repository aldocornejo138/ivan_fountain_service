...
const sliderImages = [
  ...
  },
  {
    ...
    width: 781,
    height: 1033,
    alt: "Escondido Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
  ...
  return (
    <section className="app">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Fountain Contractor Escondido, Fountain Contractor Escondido CA, Fountain Contractors Escondido, Fountain Contractors Escondido CA, Fountain Delivery Escondido, Fountain Delivery Escondido CA, Fountain Install Escondido, Fountain Install Escondido CA, Fountain Installation Escondido, Fountain Installation Escondido CA, Fountain Maintenance Escondido, Fountain Maintenance Escondido CA, Fountain Service Escondido, Fountain Service Escondido CA, Fountain Services Escondido, Fountain Services Escondido CA, Home and Garden Maintenance Escondido, Home and Garden Maintenance Escondido CA, Waterfalls Escondido, Waterfalls Escondido CA"
        />
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Escondido</h1>
