...
const sliderImages = [
  {
    ...
    width: 624,
    height: 831,
    alt: "La Quinta Fountain Service",
  },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
    alt: "La Quinta Fountain Maintenance",
  },
  {
    src: sliderImg3,
    width: 594,
    height: 787,
    alt: "La Quinta Fountain Installation",
  },
  {
    src: sliderImg4,
    width: 786,
    height: 987,
    alt: "La Quinta Fountain Repair",
  },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
    alt: "La Quinta Fountain Restoration",
  },
  {
    src: sliderImg6,
    width: 781,
    height: 1033,
    alt: "La Quinta Fountain Delivery",
  },
  {
    src: sliderImg7,
    width: 1366,
    height: 1764,
    alt: "La Quinta Fountain Replacement",
  },
  {
    src: sliderImg8,
    width: 757,
    height: 995,
    alt: "La Quinta Fountain Contractor",
  },
  {
    src: sliderImg9,
    width: 600,
    height: 775,
    alt: "La Quinta CA Fountain Maintenance",
  },
  {
    src: sliderImg10,
    width: 755,
    height: 995,
    alt: "La Quinta CA Fountain Installation",
  },
];
...
const LaQuinta = () => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service La Quinta - Ivan Fountain Service</title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves La Quinta, CA area."
        />
        <meta
          name="keywords"
          content="Fountain Contractor La Quinta, Fountain Contractor La Quinta CA, Fountain Contractors La Quinta, Fountain Contractors La Quinta CA, Fountain Delivery La Quinta, Fountain Delivery La Quinta CA, Fountain Install La Quinta, Fountain Install La Quinta CA, Fountain Installation La Quinta, Fountain Installation La Quinta CA, Fountain Maintenance La Quinta, Fountain Maintenance La Quinta CA, Fountain Service La Quinta, Fountain Service La Quinta CA, Fountain Services La Quinta, Fountain Services La Quinta CA, Home and Garden Maintenance La Quinta, Home and Garden Maintenance La Quinta CA, Waterfalls La Quinta, Waterfalls La Quinta CA"
        />
        <link rel="canonical" href="/fountain-service-La Quinta" />
      </Helmet>
      <div className="head">
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in La Quinta</h1>
      ...
      >
        <p>
          ...
          proudly serves La Quinta, CA area. We offer many services beyond
      ...
      <ServiceSection
        title="Fountain Installation La Quinta"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in La Quinta, CA."
        image1={serviceImages.delivary.src}
        image2={serviceImages.installation.src}
        alt1="La Quinta Fountain Delivery"
        alt2="La Quinta Fountain Installation"
      ...
      />
      <ServiceSection
        title="Fountain Repair La Quinta"
        ...
        alt1="La Quinta Fountain Repair"
        alt2="La Quinta CA Fountain Repair"
      ...
      />
      <ServiceSection
        title="Fountain Maintenance La Quinta"
        ...
        alt1="La Quinta Fountain Maintenance"
        alt2="La Quinta CA Fountain Maintenance"
      ...
      />
      <ServiceSection
        title="Fountain Restoration La Quinta"
        ...
        alt1="La Quinta Fountain Restoration"
        alt2="La Quinta Fountain Restoration"
