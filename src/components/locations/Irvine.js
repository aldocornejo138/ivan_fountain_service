...
const sliderImages = [
  { src: sliderImg1, width: 624, height: 831, alt: "Irvine Fountain Service" },
  {
    src: sliderImg2,
    width: 715,
    height: 939,
  ...
  { src: sliderImg4, width: 786, height: 987, alt: "Irvine Fountain Repair" },
  {
    src: sliderImg5,
    width: 611,
    height: 798,
  ...
  return (
    <section className="app">
      ...
      <motion.div
        ...
        className="title"
      >
        <h1>Fountain Services in Irvine</h1>
