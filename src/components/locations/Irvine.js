...
const Irvine = (props) => {
  ...
  return (
    <section className="app">
      <Helmet>
        <title>Fountain Service Irvine - Ivan Fountain Service </title>
        <meta
          name="description"
          content="Ivan Fountain Service has been in business for over 12 years and proudly serves Irvine, CA area."
        />
        <meta
          name="keywords"
          content="Fountain Contractor Irvine, Fountain Contractor Irvine CA, Fountain Contractors Irvine, Fountain Contractors Irvine CA, Fountain Delivery Irvine, Fountain Delivery Irvine CA, Fountain Install Irvine, Fountain Install Irvine CA, Fountain Installation Irvine, Fountain Installation Irvine CA, Fountain Maintenance Irvine, Fountain Maintenance Irvine CA, Fountain Service Irvine, Fountain Service Irvine CA, Fountain Services Irvine, Fountain Services Irvine CA, Home and Garden Maintenance Irvine, Home and Garden Maintenance Irvine CA, Waterfalls Irvine, Waterfalls Irvine CA"
        />
        <link rel="canonical" href="/fountain-service-Irvine" />
      </Helmet>
      ...
      >
        ...
        <p>
          ...
          proudly serves Irvine, CA area. We offer many services beyond fountain
        ...
        >
          ...
          >
            <SwiperSlide>
              <img
                src={sliderImg1}
                alt="Irvine Fountain Service"
                title="Irvine Fountain Service"
                width="624"
                height="831"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg2}
                alt="Irvine Fountain Maintenance"
                title="Irvine Fountain Maintenance"
                width="715"
                height="939"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg3}
                alt="Irvine Fountain Installation"
                title="Irvine Fountain Installation"
                width="594"
                height="787"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg4}
                alt="Irvine Fountain Repair"
                title="Irvine Fountain Repair"
                width="786"
                height="987"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg5}
                alt="Irvine Fountain Restoration"
                title="Irvine Fountain Restoration"
                width="611"
                height="798"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg6}
                alt="Irvine Fountain Delivary"
                title="Irvine Fountain Delivary"
                width="781"
                height="1033"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg7}
                alt="Irvine Fountain Replacement"
                title="Irvine Fountain Replacement"
                width="1366"
                height="1764"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg8}
                alt="Irvine Fountain Contractor"
                title="Irvine Fountain Contractor"
                width="757"
                height="995"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg9}
                alt="Irvine CA Fountain Maintenance"
                title="Irvine CA Fountain Maintenance"
                width="600"
                height="775"
                loading="lazy"
              />
            ...
            <SwiperSlide>
              <img
                src={sliderImg10}
                alt="Irvine CA Fountain Installation"
                title="Irvine CA Fountain Installation"
                width="755"
                height="995"
                loading="lazy"
              />
      ...
      <ServiceSection
        title="Fountain Installation Irvine"
        description="One of the best ways to improve the esthetic of your property is
              ...
              is the first and only call you need to make in Irvine, CA."
        image1={delivary}
        image2={Installation}
        alt1="Irvine Fountain Delivery"
        alt2="Irvine Fountain Installation"
        width1="1500"
        height1="2000"
        width2="1500"
        height2="2000"
        Title1="Irvine Fountain Installation"
        Title2="Irvine CA Fountain Delivery"
      />

      <ServiceSection2
        title="Fountain Repair Irvine"
        ...
        image1={beforeRepair}
        image2={afterRepair}
        alt1="Irvine Fountain Repair"
        alt2="Irvine Ca Fountain Repair"
        width1="1029"
        height1="1831"
        width2="2048"
        height2="2506"
        Title1="Irvine Fountain Repair"
        Title2="Irvine CA Fountain Repair"
      />

      <ServiceSection
        title="Fountain Maintenance Irvine"
        ...
        image1={maintenance}
        image2={maintenance2}
        alt1="Irvine Fountain Maintenance"
        alt2="Irvine CA Fountain Maintenance"
        width1="1440"
        height1="1920"
        width2="1500"
        height2="2000"
        Title1="Irvine Fountain Maintenance"
        Title2="Irvine CA Fountain Maintenance"
      />

      <ServiceSection2
        title="Fountain Restoration Irvine"
        ...
        image1={emergency}
        image2={business}
        alt1="Irvine Fountain Restoration"
        alt2="Irvine Fountain Restoration"
        width1="1150"
        height1="2048"
        width2="1474"
        height2="2394"
        Title1="Irvine Fountain Restoration"
        Title2="Irvine CA Fountain Restoration"
      />
      <Reviews />
      <Contact />
      <Footer />
